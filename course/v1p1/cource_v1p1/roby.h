...
//Коды (поле code) ИМПУЛЬСНЫХ сообщений от датчиков крайних положений
	//по координатам W и F:
#define W_END		0x08
#define W_BEGIN		0x10
#define F_END		0x20
#define F_BEGIN		0x40
...
//Коды импульсов таймера для заполнения структуры (уведомления) sigevent
	//в потоке DisplayWF:
